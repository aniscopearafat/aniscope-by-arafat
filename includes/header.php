...
<head>
    ...
    <meta
        name="description"
        content="Bangla anime reviews, character analysis, manga updates and anime news."
    >
    ...
    <link
        rel="icon"
        href="/assets/images/logo-mark.svg"
        type="image/svg+xml"
    >
    ...
    <div class="container nav-wrap">
        ...
        >
            ...
            <?php foreach ($navigation as $label => $href): ?>
                ...
                <a
                    class="<?= $activePage === strtolower($label) ? 'active' : '' ?>"
                    href="<?= e($href) ?>"
                >
                    <?= e($label) ?>
                </a>
